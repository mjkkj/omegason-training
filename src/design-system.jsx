...
export function Ico({ name, s = 16, c = 'currentColor', sw = 1.6 }) {
  ...
  const paths = {
    ...
    folder: <><path d="M2 4.5a1 1 0 011-1h3l1.3 1.5H13a1 1 0 011 1V12a1 1 0 01-1 1H3a1 1 0 01-1-1z"/></>,
    download: <><path d="M8 2.5V10M5 7.5L8 10.5 11 7.5"/><path d="M3 12.5h10"/></>,
  };
