...
// videos: link video gợi ý {url, title} (quản lý có thể bổ sung trong Nội dung đào tạo) · description: đầu ra cần nộp
export const TASK_CONTENT = {
  '01': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=Ym-HQ60I2m8', title: 'The NEW WAY to Find Winning Dropshipping Products (2025)' },
      { url: 'https://www.youtube.com/watch?v=SuiWZsBuJZQ', title: 'How I Find $10K/Month Winning Dropshipping Products (2025)' },
      { url: 'https://www.youtube.com/watch?v=7e_pFgyCLDo', title: 'Find Winning Products — Shopify Product Research Strategy' },
    ],
  ...
  '02': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=ljJ3OHZ5Z2U', title: 'Full Shopify Store Setup Tutorial For Beginners (2025)' },
      { url: 'https://www.youtube.com/watch?v=USxPnHUWzr8', title: 'Best Shopify Tutorial 2025 — Full Step-by-Step Guide' },
      { url: 'https://www.youtube.com/watch?v=lPJcblKvu6Q', title: 'Meta Pixel + Conversions API on Shopify (2025) Step-by-Step' },
    ],
  ...
  '03': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=1UnRwiuvMUE', title: 'Compelling Product Descriptions That Boost Conversions (2025)' },
      { url: 'https://www.youtube.com/watch?v=E5GjubFYv5Q', title: 'eCommerce Product Descriptions with ChatGPT — Shopify Listings' },
      { url: 'https://www.youtube.com/watch?v=v0nRnoEXE8w', title: 'Write Shopify Product Descriptions With ChatGPT That Sell' },
    ],
  ...
  '04': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=q-_wSPr4md8', title: 'The BEST Performing 24 Ad Hooks for Meta in 2025' },
      { url: 'https://www.youtube.com/watch?v=iSOT16eF4bM', title: '10 Facebook Ad Hooks That Will SCALE in 2025' },
      { url: 'https://www.youtube.com/watch?v=t-Xf12o4jt4', title: 'I Tested Over 1000 Ads — Hooks Actually Making Money (2025)' },
    ],
  ...
  '05': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=3lh8L6g2tPs', title: 'Best Facebook Ads Strategy For Shopify 2025 (Step-By-Step)' },
      { url: 'https://www.youtube.com/watch?v=qKNBcMjRBnA', title: 'My Facebook Ads TESTING Strategy For 2025 (Shopify)' },
      { url: 'https://www.youtube.com/watch?v=2ijV5BimNDo', title: 'How To Run Facebook Ads For Shopify 2025 (Setup + Full)' },
    ],
  ...
  '06': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=HqrqJ-QQbqE', title: 'How To Analyze Your Facebook Ads For Better ROAS (2025)' },
      { url: 'https://www.youtube.com/watch?v=CCsty8R0UaA', title: 'How to Analyze Facebook Ads Data the Right Way (2025)' },
      { url: 'https://www.youtube.com/watch?v=8WotxGy018A', title: '2025 Meta Ads Benchmarks by Industry (CTR, CPC, CPM, ROAS)' },
    ],
  ...
  '07': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=1mNxgfRoMuo', title: 'Shopify Analytics 2025 For Beginners — Everything You Need' },
      { url: 'https://www.youtube.com/watch?v=KD8_PVCnBxs', title: 'Audit: Double Conversions & AOV on a Shopify Store' },
      { url: 'https://www.youtube.com/watch?v=kLneJKAqRtk', title: 'How To Increase Conversion Rate On Shopify (2025 CRO Guide)' },
    ],
  ...
  '08': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=MKSpPDrhfhU', title: 'Run Facebook Ads for Dropshipping — Testing & Scaling (2026)' },
      { url: 'https://www.youtube.com/watch?v=aNP_MtACjhU', title: 'How I Test + Scale Facebook Ads for Dropshipping (2025)' },
      { url: 'https://www.youtube.com/watch?v=E5A5cDPr0OI', title: 'Testing Facebook Ads in 2025 (Post-Andromeda Update)' },
    ],
  ...
  'F': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=vEPVIO7MccA', title: 'How to Present a Case Study Presentation (Like a Boss, 2025)' },
      { url: 'https://www.youtube.com/watch?v=rWnLsawUAMc', title: 'Marketing Analytics Case Study Walkthrough (2025)' },
      { url: 'https://www.youtube.com/watch?v=qt0rbcXxvQs', title: 'How To Write A Marketing Case Study In 5 Easy Steps' },
    ],
