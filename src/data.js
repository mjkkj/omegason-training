...
export const TASK_CONTENT = {
  '01': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=7e_pFgyCLDo', title: 'How To Find Winning Dropshipping Products (Product Research)' },
      { url: 'https://www.youtube.com/watch?v=Cz3qURhcVX0', title: 'Ultimate Guide To Product Research For Dropshipping' },
      { url: 'https://www.youtube.com/watch?v=_zu0Hd4wAcw', title: 'Shopify Product Research — Find Winning Products Step By Step' },
    ],
  ...
  '02': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=ljJ3OHZ5Z2U', title: 'Full Shopify Store Setup Tutorial For Beginners' },
      { url: 'https://www.youtube.com/watch?v=lDG8OnKYdp4', title: 'Setup Facebook Pixel + Conversion API for Shopify' },
      { url: 'https://www.youtube.com/watch?v=del1tza_7es', title: 'Facebook Conversions API for Shopify in 10 Minutes' },
    ],
  ...
  '03': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=LrNhsXnvEtw', title: "How To Write Product Descriptions That Don't Suck (eCom)" },
      { url: 'https://www.youtube.com/watch?v=99v1YVyUcLI', title: 'E-Commerce Copywriting 101: Killer Product Descriptions' },
      { url: 'https://www.youtube.com/watch?v=l7Usi5AGeS4', title: 'Write Shopify Product Descriptions That SELL' },
    ],
  ...
  '04': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=t-Xf12o4jt4', title: 'I Tested Over 1000 Ads — Hooks Actually Making Money' },
      { url: 'https://www.youtube.com/watch?v=Yi_1Vb4sfoQ', title: 'The Recipe for the Perfect UGC Ad (Facebook & TikTok)' },
      { url: 'https://www.youtube.com/watch?v=0K7WXqYPFCE', title: '10 Best Hooks For Facebook Ad Creatives (eCom)' },
    ],
  ...
  '05': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=QVc2T9mb1qI', title: '3 Facebook Ad Campaign Structures for Dropshipping' },
      { url: 'https://www.youtube.com/watch?v=0KnHRWPvAik', title: 'Exactly How To Run Facebook Ads for Dropshipping' },
      { url: 'https://www.youtube.com/watch?v=VECAGJYED2o', title: 'Run Facebook Ads For Dropshipping — Full Beginners Guide' },
    ],
  ...
  '06': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=Ws-jGm_JTVI', title: 'Performance Marketing Metrics: CPC, CPA, ROAS, CTR Explained' },
      { url: 'https://www.youtube.com/watch?v=CCsty8R0UaA', title: 'How to Analyze Facebook Ads Data the Right Way' },
      { url: 'https://www.youtube.com/watch?v=3uUxZi25nbI', title: 'How To Analyze Facebook Ads For Ecommerce (10x ROAS)' },
    ],
  ...
  '07': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=1mNxgfRoMuo', title: 'Shopify Analytics For Beginners — Everything You Need To Know' },
      { url: 'https://www.youtube.com/watch?v=7fbgnkiEVyk', title: 'How To Check Conversion Rate in Shopify (Full Guide)' },
      { url: 'https://www.youtube.com/watch?v=_pfxcwo1d9k', title: 'Increase AOV & Conversion Rate for Shopify Brands' },
    ],
  ...
  '08': {
    ...
    videos: [
      { url: 'https://www.youtube.com/watch?v=cqxY8SwjQ78', title: 'Best Strategy To Kill & Scale Ad Sets (Dropshipping)' },
      { url: 'https://www.youtube.com/watch?v=y7lv1Us2n9w', title: 'How I Test + Scale Dropshipping Products Using Facebook Ads' },
      { url: 'https://www.youtube.com/watch?v=Vg30rO24gpM', title: 'How I Scale Facebook Ads for My $200k/mo Store' },
    ],
  ...
  'F': {
    ...
    videos: [
      ...
      { url: 'https://www.youtube.com/watch?v=vEPVIO7MccA', title: 'How to Present a Case Study Presentation (Like a Boss)' },
      { url: 'https://www.youtube.com/watch?v=rWnLsawUAMc', title: 'Marketing Analytics Case Study Walkthrough' },
    ],
